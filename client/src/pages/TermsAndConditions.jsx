    ...
    return (
        <div className="min-h-screen bg-gray-100 py-12 px-4">
            <div className="container mx-auto max-w-4xl bg-white p-8 rounded-lg shadow-md mt-6">
                <h1 className="text-3xl font-bold mb-8 text-gray-800 border-b pb-4">Kishuka Travels – Terms & Conditions</h1>
                
                <div className="space-y-8 text-gray-700">
                    <section>
                        <h2 className="text-xl font-semibold text-gray-800 mb-4">General Terms</h2>
                        <ul className="list-disc pl-6 space-y-2">
                            <li>For any complaints or queries, passengers may contact Kishuka Travels customer support.</li>
                            ...
                            <li>Kishuka Travels reserves the right to change seat allocation if required due to operational reasons.</li>
                            <li>Kishuka Travels shall not be responsible for any injury, loss, damage, delay, or inconvenience caused due to accidents, breakdowns, traffic conditions, or natural calamities.</li>
                            ...
                            <li>Kishuka Travels is not liable for trip cancellations due to unforeseen circumstances beyond management control.</li>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li>Kishuka Travels reserves the right to modify cancellation policies at any time without prior notice.</li>
